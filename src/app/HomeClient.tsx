...
export default function HomeClient({
  ...
  const achievementRate = Math.round((visitedCount / 47) * 100)
    ...
    <div className="w-screen h-screen flex flex-col">
      <header className="h-14 bg-white shadow grid grid-cols-3 items-center px-4">
        <div className="font-medium">
          {user ? (
            <>達成率：{achievementRate}%（{visitedCount} / 47）</>
          ) : null}
        </div>
        <h1 className="text-3xl font-bold text-center cursor-pointer" onClick={() => router.push("/")}>
          旅ログ
        </h1>
      ...
      <div className="JapanMap flex-1 flex items-center justify-center bg-gray-100 overflow-hidden">
        <svg className="geolonia-svg-map w-full h-full object-contain" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
          ...
          <g className="svg-map" transform="matrix(1.028807, 0, 0, 1.028807, -47.544239, -28.806583)">
            <g className="prefectures" transform="matrix(1, 0, 0, 1, 6, 18)">
              <g
                className={`okinawa kyushu-okinawa prefecture cursor-pointer
                   ${visitedPrefectures.includes("沖縄県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="47" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(52.000000, 193.000000)" onClick={() => handleClick("okinawa", "沖縄県")}
              >
              ...
              <g
                className={`kagoshima kyushu kyushu-okinawa prefecture hover:fill-red-600
                 cursor-pointer
                   ${visitedPrefectures.includes("鹿児島県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="46" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(96.000000, 17.000000)" onClick={() => handleClick("kagoshima", "鹿児島県")}
              >
              ...
              <g
                className={`miyazaki kyushu kyushu-okinawa prefecture  cursor-pointer
                   ${visitedPrefectures.includes("宮崎県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="45" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(152.000000, 824.000000)" onClick={() => handleClick("miyazaki", "宮崎県")}
              >
              ...
              <g
                className={`oita kyushu kyushu-okinawa prefecture cursor-pointer
                   ${visitedPrefectures.includes("大分県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="44" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(163.000000, 771.000000)" onClick={() => handleClick("oita", "大分県")}
              >
                <title>大分 / Oita</title>
              ...
              <g
                className={`kumamoto kyushu kyushu-okinawa prefecture cursor-pointer
                   ${visitedPrefectures.includes("熊本県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="43" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(115.000000, 800.000000)" onClick={() => handleClick("kumamoto", "熊本県")}
              >
              ...
              <g className={`nagasaki kyushu kyushu-okinawa prefecture cursor-pointer
                   ${visitedPrefectures.includes("長崎県")
                  ? "fill-green-600"
                  : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="42" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(44.000000, 700.000000)" onClick={() => handleClick("nagasaki", "長崎県")}
              >
              ...
              <g
                className={`saga kyushu kyushu-okinawa prefecture cursor-pointer
                   ${visitedPrefectures.includes("佐賀県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="41" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(108.000000, 773.000000)" onClick={() => handleClick("saga", "佐賀県")}
              >
                <title>佐賀 / Saga</title>
              ...
              <g
                className={`fukuoka kyushu kyushu-okinawa prefecture cursor-pointer
                   ${visitedPrefectures.includes("福岡県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="40" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(123.000000, 752.000000)" onClick={() => handleClick("fukuoka", "福岡県")}
              >
              ...
              <g
                className={`kochi shikoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("高知県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="39" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(251.000000, 765.000000)" onClick={() => handleClick("kochi", "高知県")}
              >
              ...
              <g
                className={`ehime shikoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("愛媛県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="38" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(225.000000, 737.000000)" onClick={() => handleClick("ehime", "愛媛県")}
              >
              ...
              <g
                className={`kagawa shikoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("香川県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="37" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(308.000000, 724.000000)" onClick={() => handleClick("kagawa", "香川県")}
              >
              ...
              <g
                className={`tokushima shikoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("徳島県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="36" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(312.000000, 744.000000)" onClick={() => handleClick("tokushima", "徳島県")}
              >
              ...
              <g
                className={`yamaguchi chugoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("山口県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="35" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(168.000000, 710.000000)" onClick={() => handleClick("yamaguchi", "山口県")}
              >
              ...
              <g
                className={`hiroshima chugoku prefecture" data-code="34 cursor-pointer
                   ${visitedPrefectures.includes("広島県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(230.000000, 687.000000)" onClick={() => handleClick("hiroshima", "広島県")}
              >
              ...
              <g
                className={`okayama chugoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("岡山県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="33" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(295.000000, 673.000000)" onClick={() => handleClick("okayama", "岡山県")}
              >
              ...
              <g
                className={`shimane chugoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("島根県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="32" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(211.000000, 610.000000)" onClick={() => handleClick("shimane", "島根県")}
              >
              ...
              <g className={`tottori chugoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("鳥取県")
                  ? "fill-green-600"
                  : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="31" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(288.000000, 658.000000)" onClick={() => handleClick("tottori", "鳥取県")}
              >
              ...
              <g className={`wakayama kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("和歌山県")
                  ? "fill-green-600"
                  : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="30" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(385.000000, 737.000000)" onClick={() => handleClick("wakayama", "和歌山県")}
              >
              ...
              <g
                className={`nara kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("奈良県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`} data-code="29" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(410.000000, 712.000000)" onClick={() => handleClick("nara", "奈良県")}
              >
                <title>奈良 / Nara</title>
              ...
              <g
                className={`hyogo kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("兵庫県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="28" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(345.000000, 655.000000)" onClick={() => handleClick("hyogo", "兵庫県")}
              >
              ...
              <g
                className={`osaka kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("大阪府")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="27" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(387.000000, 695.000000)" onClick={() => handleClick("osaka", "大阪府")}
              >
              ...
              <g
                className={`kyoto kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("京都府")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="26" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(377.000000, 649.000000)" onClick={() => handleClick("kyoto", "京都府")}
              >
              ...
              <g
                className={`shiga kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("滋賀県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="25" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(423.000000, 655.000000)" onClick={() => handleClick("siga", "滋賀県")}
              >
              ...
              <g
                className={`mie kinki prefecture cursor-pointer
                   ${visitedPrefectures.includes("三重県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="24" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(426.000000, 683.000000)" onClick={() => handleClick("mie", "三重県")}
              >
                <title>三重 / Mie</title>
              ...
              <g
                className={`aichi chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("愛知県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="23" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(469.000000, 673.000000)" onClick={() => handleClick("aichi", "愛知県")}
              >
              ...
              <g
                className={`shizuoka chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("静岡県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="22" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(511.000000, 659.000000)" onClick={() => handleClick("shizuoka", "静岡県")}
              >
              ...
              <g className={`gifu chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("岐阜県")
                  ? "fill-green-600"
                  : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="21" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(450.000000, 608.000000)" onClick={() => handleClick("gihu", "岐阜県")}
              >
                <title>岐阜 / Gifu</title>
              ...
              <g
                className={`nagano chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("長野県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="20" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(503.000000, 572.000000)" onClick={() => handleClick("nagano", "長野県")}
              >
              ...
              <g
                className={`yamanashi chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("山梨県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="19" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(546.000000, 638.000000)" onClick={() => handleClick("yamanashi", "山梨県")}
              >
              ...
              <g
                className={`fukui chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("福井県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="18" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(408.000000, 618.000000)" onClick={() => handleClick("fukui", "福井県")}
              >
              ...
              <g
                className={`ishikawa chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("石川県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="17" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(448.000000, 541.000000)" onClick={() => handleClick("ishikawa", "石川県")}
              >
              ...
              <g
                className={`toyama chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("富山県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="16" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(475.000000, 575.000000)" onClick={() => handleClick("toyama", "富山県")}
              >
              ...
              <g
                className={`niigata chubu prefecture cursor-pointer
                   ${visitedPrefectures.includes("新潟県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="15" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(518.000000, 476.000000)" onClick={() => handleClick("niigata", "新潟県")}
              >
              ...
              <g
                className={`kanagawa kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("神奈川県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="14" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(584.000000, 656.000000)" onClick={() => handleClick("kanagawa", "神奈川県")}
              >
              ...
              <g
                className={`tokyo kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("東京都")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="13" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(585.000000, 642.000000)" onClick={() => handleClick("tokyo", "東京都")}
              >
              ...
              <g
                className={`chiba kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("千葉県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="12" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(627.000000, 629.000000)" onClick={() => handleClick("chiba", "千葉県")}
              >
              ...
              <g
                className={`saitama kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("埼玉県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="11" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(573.000000, 618.000000)" onClick={() => handleClick("saitama", "埼玉県")}
              >
              ...
              <g
                className={`gunma kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("群馬県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="10" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(557.000000, 570.000000)" onClick={() => handleClick("gunma", "群馬県")}
              >
              ...
              <g
                className={`tochigi kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("栃木県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="9" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(603.000000, 563.000000)" onClick={() => handleClick("tovhigi", "栃木県")}
              >
              ...
              <g
                className={`ibaraki kanto prefecture cursor-pointer
                   ${visitedPrefectures.includes("茨城県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="8" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(622.000000, 575.000000)" onClick={() => handleClick("ibaraki", "茨城県")}
              >
              ...
              <g
                className={`fukushima tohoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("福島県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="7" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(594.000000, 511.000000)" onClick={() => handleClick("fukushima", "福島県")}
              >
              ...
              <g
                className={`yamagata tohoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("山形県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="6" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(612.000000, 439.000000)" onClick={() => handleClick("yamagata", "山形県")}
              >
              ...
              <g
                className={`akita tohoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("秋田県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="5" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(617.000000, 352.000000)" onClick={() => handleClick("akita", "秋田県")}
              >
              ...
              <g
                className={`miyagi tohoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("宮城県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="4" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(648.000000, 445.000000)" onClick={() => handleClick("miyagi", "宮城県")}
              >
              ...
              <g
                className={`iwate tohoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("岩手県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="3" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(664.000000, 354.000000)" onClick={() => handleClick("iwate", "岩手県")}
              >
              ...
              <g
                className={`aomori tohoku prefecture cursor-pointer
                   ${visitedPrefectures.includes("青森県")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="2" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(624.000000, 287.000000)" onClick={() => handleClick("aomori", "青森県")}
              >
              ...
              <g
                className={`hokkaido prefecture cursor-pointer
                   ${visitedPrefectures.includes("北海道")
                    ? "fill-green-600"
                    : "fill-gray-300"} 
                    hover:fill-red-600`}
                data-code="1" strokeLinejoin="round" fillRule="nonzero" stroke="#000000" strokeWidth="1.0" transform="translate(602.000000, 10.000000)" onClick={() => handleClick("hokkaido", "北海道")}
              >
            ...
            <g className="boundary-line stroke-gray-200" strokeWidth="5" strokeLinejoin="round">
